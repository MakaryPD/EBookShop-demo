...
<html>
	...
	<body>
		<div id="Container">
			...
			<div id="content">
			<h3>You have successfully bought this items. Thank you and visit us again.</h3> 
				<p>
				<a class="side" href="${pageContext.request.contextPath }/Home/book_list"> <b>back to book list.</b></a>
			</div>
			<div id="footer">
